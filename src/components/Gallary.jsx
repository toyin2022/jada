        ...
        { image: parallax, speed: -50 },
        {
          ...
          children: (
            <div className="absolute h-full w-full  text-white bg-gradient-to-b from-black/80 to-black/80  inset-0 flex items-center justify-center flex-col">
              ...
              <div className="w-full relative flex flex-col gap-3 py-10">
                <div className="absolute h-[40rem] w-full px-12 bg-black -z-10 mt-52"></div>
                <div className="px-10 w-full flex  gap-3 py-10">
                ...
                <div className="mt-10 w-52 mx-auto flex items-center justify-center ">
